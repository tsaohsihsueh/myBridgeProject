...
Custom Hand Generation: 
    Take control of your practice. You can specify exactly which opening bid you want to practice and set your partner’s point range to simulate specific bidding scenarios.
...
Generate: Choose to view a single hand for quick study or a full set for a session.

Export: If generating a set, look for the output.lin file in your directory to upload to BBO.
